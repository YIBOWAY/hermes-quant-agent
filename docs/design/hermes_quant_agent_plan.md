...
> **路线与阶段以 `docs/design/2026-07-01-roadmap-phases-0b-4.md` 的决策台账（D-1…D-33）为准**；本文为背景调研与总设计，个别章节（如人工 paper Gate）已被 D-33 的“自动 paper、人工 live”条件化修订。当前执行状态先看 `docs/README.md`。
