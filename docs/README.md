...
| D-34 Mandate 双引擎 paper | [`plans/2026-08-11-d34-mandate-dual-engine-paper.md`](plans/2026-08-11-d34-mandate-dual-engine-paper.md) | 当前 source 实施计划：Futu snapshot → RD-Agent/Qlib → Platform replay → Artifact/Policy → 真实 paper canary。独立 worktree 开发，030–032 尚未正式 apply/runtime 部署，不得提前宣称已常驻。 |
