...
| Plan-era upstream note | Implementation plan text recorded plan-era `e4ea0a0e`; **live reconfirm is `b03c94db`**. Snapshot truth for the checked-in contract is `b03c94db`. |
