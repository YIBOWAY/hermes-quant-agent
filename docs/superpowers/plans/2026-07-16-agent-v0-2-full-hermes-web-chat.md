...
> token stream / launchd 常驻 / public V8 仍未做（V7a–V7g-B-M5 decide/release/stop/projector/Gate-surfaces/typed-results/hermetic+authorized-live-RO Vertical A + hermetic Vertical B bind+plan-confirm+Gate1 seed+Gate1 confirm+Gate2 seed ACCEPT；M6 Gate2 decide couple 未授权）。
>
...
| Plan-V6 完整 UI | **PARTIAL / NEXT** | assistant token stream 等仍未做；a11y M1 + V7a–V7g-B-M5 ACCEPT；optional token stream → V8 OPEN |
...
- transcript + assistant stream、Task drawer、plan/step、typed result canvas、provider/usage、
  ...
  V7a–V7g-B-M5 decide/release/stop/projector/Gate-surfaces/typed-results/hermetic+authorized-live-RO Vertical A + hermetic Vertical B bind+plan-confirm+Gate1 seed+Gate1 confirm+Gate2 seed ACCEPT；token stream / M6 Gate2 decide 仍未做。
...
| V6 final workspace UI | **PARTIAL（2026-07-23）** | 本地 dark enablement + L2a–L5c thin rail ACCEPT（含 L5b/L5c）；V7a–V7g-B-M5 decide/release/stop/projector/Gate-surfaces/typed-results/hermetic+live-RO Vertical A + hermetic Vertical B bind+plan-confirm+Gate1 seed+Gate1 confirm+Gate2 seed ACCEPT；token stream 仍 NEXT；public chat 仍 OFF |
| V7 decisions/results/vertical slices | **PARTIAL（V7a–V7g-B-M5 ACCEPT@2026-07-22…23）** | command-approval decide/release/stop/projector + Gate surfaces + typed results + Vertical A hermetic+live RO + Vertical B hermetic bind+plan-confirm+Gate1 seed+Gate1 confirm+Gate2 seed green；optional token stream / **M6 Gate2 decide 未授权** 仍 OPEN |
