...
print(distribution)
PY
env -u PYTHONHOME -u PYTHONPATH .venv/bin/python -X int_max_str_digits=0 -I -m pytest --import-mode=importlib
cd "$source_checkout"
rm -R "$fresh_checkout"
```
...
exercised on Python 3.11; it is not a runtime setting.
